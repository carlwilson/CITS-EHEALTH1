...
java -jar ./spec-publisher/target/mets-profile-processor-0.1.0-SNAPSHOT.jar -f ./specification.yaml -o doc/site profile/E-ARK-eHealth1-ROOT_v2.0.1.xml profile/E-ARK-eHealth1-REPRESENTATION_v2.0.1.xml 
